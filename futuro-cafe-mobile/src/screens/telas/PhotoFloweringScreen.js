  ...
  return (
    <View style={dynamicStyles.container}>
      ...
      <View style={dynamicStyles.content}>
        <Image source={floweringImage} style={dynamicStyles.image} />
...
export default PhotoFloweringScreen;
