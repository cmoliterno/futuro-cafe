  ...
  return (
    <View style={dynamicStyles.container}>
      ...
      <View style={dynamicStyles.content}>
        <Image source={harvestImage} style={dynamicStyles.image} />
...
export default PhotoHarvestScreen;
